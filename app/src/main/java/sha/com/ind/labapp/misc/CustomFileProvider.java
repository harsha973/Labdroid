...
/**
 * File provider that supports legacy apps (e.g. Messaging on Lollipop).
 *
 * From http://stackoverflow.com/a/25020642
 *
 */
public class CustomFileProvider extends android.support.v4.content.FileProvider {
